      ...
      <div id="part-3" className="p-5">
        ...
        <div id="skillShowHide" style={{ display: display }}>
          <div className="me-2" id="selected">
            {selected.map((skill) => (
              <button
                className="btn btn-outline-danger mt-2 rounded-pill me-2"
                type="button"
                onClick={() => removeSkill(skill.language)}
              >
                {skill.language + " "}
          ...
          <div id="set">
            ...
            {suggested.map((skill) => (
              <button
                className="btn btn-outline-primary mt-2 rounded-pill me-2"
                type="button"
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div id="slider_count">
                  Experience = <span id="sliderStatus">{tempExp}</span>
                </div>
                <br />
                <input
                  type="range"
        ...
        <input
          id="search"
          onKeyUp={(e) => displaySkills(e.target.value)}
          className="form-control me-2 mb-3 rounded-pill "
          type="search"
          placeholder="Search"
          aria-label="Search"
        />
        ...
        <button
          ...
          id="btn-3"
          type="button"
          className="btn btn-primary ms-2 mb-3 rounded-pill"
          disabled={nextButton.next3 >= 2 ? false : true}
        >
          Next
        </button>
      </div>
