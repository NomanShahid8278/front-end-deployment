    ...
    <>
      <div id="criteria">
        <div className="mb-3" onChange={setUniValue}>
          <label className="mb-2" for="ice-cream-choice">
            Please Enter your University Name{" "}
            <span style={{ color: "red" }}>{props.uniErr}</span>
          </label>
          <input
            onChange={(e) => {
        ...
        <div className="mb-3" style={{ display: props.displayInputFile }}>
          <label className="mb-2" for="myfile">
            Upload Your Transcript{" "}
            <span style={{ color: "red" }}>{props.transErr}</span>{" "}
          </label>
          <input
            onChange={(e) => {
              dispatch({
...
const Part1 = () => {
  ...
  const [displayInputFile, setDisplayInputFile] = useState(
    inputFileDisplay.fileD
  );
  ...
  return (
    <>
      <div id="part-1" className="p-5">
        ...
        <div id="radio-1" onChange={handleOnChangeRadio1}>
          <div className="form-check ">
            <input
              ...
              checked={valr1[0] === stateMaintain.radio1}
          ...
          <div className="form-check">
            <input
              ...
              checked={valr1[1] === stateMaintain.radio1}
              className="form-check-input"
              type="radio"
              name="flexRadioDefault"
          ...
          <div className="form-check">
            <input
              ...
              checked={valr1[2] === stateMaintain.radio1}
              className="form-check-input"
              type="radio"
              name="flexRadioDefault"
        ...
        <br />
        <form action="">
          {stateMaintain.radio1 === valr1[0] ||
          stateMaintain.radio1 === valr1[1] ? (
            <Unexp
              uniErr={uniError}
              transErr={transError}
              displayInputFile={displayInputFile}
              setDisplayInputFile={setDisplayInputFile}
        ...
        <div id="radio-2" onChange={handleOnChangeRadio2}>
          <div className="form-check">
            <input
              checked={valr2[0] === stateMaintain.radio2}
              className="form-check-input"
              type="radio"
          ...
          <div className="form-check">
            <input
              checked={valr2[1] === stateMaintain.radio2}
              className="form-check-input"
              type="radio"
              name="flexRadioDefault1"
          ...
          <div className="form-check">
            <input
              checked={valr2[2] === stateMaintain.radio2}
              className="form-check-input"
              type="radio"
              name="flexRadioDefault1"
        ...
        <button
          ...
          disabled={nextButton.next1[0] && nextButton.next1[1] ? false : true}
        >
          Next
        </button>
      </div>
